...
if __name__ == '__main__':
    ...
    for data in d:
        ...
        parser.add_argument('--embedder', nargs='?', default='AE')
        ...
        parser.add_argument('--hid_units', type=int, default=64, help='低维特征维度')
        parser.add_argument('--n_h', type=int, default=64, help='低维特征维度')
