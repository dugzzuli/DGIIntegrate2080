...
if __name__ == '__main__':
    ...
    d=['3sources'] #['Caltech101-7'] #['Reuters','yale_mtv','MSRCv1','3sources','small_Reuters','small_NUS','BBC','BBCSport'，‘LandUse-21’] # ['BBCSport','yale_mtv','MSRCv1','3sources']
    atten=False
    # vis = Visualizer("env")
    vis=None
    for data in d:
        for link in ['Mean']:
            ...
            with open(filePath, 'a+') as f:
                ...
                print(args)
                from models import DMGIN2
                embedder = DMGIN2(args)
