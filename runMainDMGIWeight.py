...
if __name__ == '__main__':
    ...
    d=['3sources'] #['Reuters','yale_mtv','MSRCv1','3sources','small_Reuters','small_NUS','BBC','BBCSport'，‘LandUse-21’] # ['BBCSport','yale_mtv','MSRCv1','3sources']
    atten=False
    # vis = Visualizer("env")
    vis=None
    for data in d:
        for link in ['Mean']:
            ...
            # input arguments
            parser = argparse.ArgumentParser(description='DMGIWeight')
            parser.add_argument('--embedder', nargs='?', default='DMGIWeight')
            ...
            with open(filePath, 'a+') as f:
                ...
                print(args)
                from models import DMGIWeight
                embedder = DMGIWeight(args)
